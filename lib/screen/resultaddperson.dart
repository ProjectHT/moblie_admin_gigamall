...
class ResultAddPersonView extends StatefulWidget {
  ResultAddPersonView({Key? key}) : super(key: key);
  static const routeName = '/ResultAddPersonView';
  @override
  State<StatefulWidget> createState() => ResultAddPersonViewState();
}

class ResultAddPersonViewState extends State<ResultAddPersonView> {
  @override
